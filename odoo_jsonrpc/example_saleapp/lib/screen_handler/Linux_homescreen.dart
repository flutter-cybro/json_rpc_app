...
class LinuxHomeScreen extends StatefulWidget {
...
class _LinuxHomeScreenState extends State<LinuxHomeScreen> {
  ...
  final client = OdooClientController(); // Define the OdooClientController instance
  String? url;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: HomeDrawer(clientController: client), // Pass the client instance here
